...
const YourTrusted = () => {
  return (
    <div className="w-full bg-[#F9F8F5] min-h-98 bg-center object-contain bg-cover bg-no-repeat bg-[url('/assets/images/webp/trusted-bg.webp')] px-4 sm:px-6">
      
      <div className="max-w-198.75 w-full mx-auto pt-12 sm:pt-16 lg:pt-11.25">
        
        <h6 className="font-semibold text-3xl sm:text-4xl lg:text-5xl text-[#010101] leading-[120%] text-center">
          Your Trusted Upholstery 
          <span className='text-[#19AE1A]'> Experts in Singapore </span>
        </h6>
        ...
        <button className="flex mt-6 lg:mt-8 mx-auto cursor-pointer w-48 md:w-59.75 h-12.5 rounded-[245px] items-center justify-center gap-2.5 bg-[#19AE1A] text-[#fafafa] font-semibold leading-[160%] text-base">
